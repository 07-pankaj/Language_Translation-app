...
class cColorFragment : Fragment(),onclick {
    ...
    override fun onCreateView(
        ...
        val view:View =  inflater.inflate(R.layout.fragment_c_color, container, false)
        val viewmodel = ViewModelProvider(requireActivity()).get(ChineseViewModel::class.java)

        val recycleview:RecyclerView = view.findViewById(R.id.c_crecycleview)
        recycleview.layoutManager = LinearLayoutManager(context)

        val adp = RecycleViewadapter(viewmodel.getdataofcolor(),this)
