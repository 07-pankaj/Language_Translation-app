...
class cFamilyFragment : Fragment(),onclick {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_c_family, container, false)
        val viewmodel = ViewModelProvider(requireActivity()).get(ChineseViewModel::class.java)

        val recycleview: RecyclerView = view.findViewById(R.id.c_frecycleview)
