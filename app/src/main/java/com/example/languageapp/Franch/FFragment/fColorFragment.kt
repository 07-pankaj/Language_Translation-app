...
class fColorFragment : Fragment(),onclick {
    ...
    override fun onCreateView(
        ...
        val view:View = inflater.inflate(R.layout.fragment_f_color, container, false)

        val viewmodel = ViewModelProvider(requireActivity()).get(FranchViewModel::class.java)
        val recycleview: RecyclerView = view.findViewById(R.id.f_crecycleview)
