...
class fFamilyFragment : Fragment(),onclick {
    ...
    override fun onCreateView(
        ...
        val view:View = inflater.inflate(R.layout.fragment_f_family, container, false)

        val viewmodel = ViewModelProvider(requireActivity()).get(FranchViewModel::class.java)
        val recycleview: RecyclerView = view.findViewById(R.id.f_frecycleview)
        recycleview.layoutManager = LinearLayoutManager(context)

        val adp = RecycleViewadapter(viewmodel.getdataoffamily(),this)
